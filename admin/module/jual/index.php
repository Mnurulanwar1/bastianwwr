...
?>
    ...
    <input type="number" name="jumlah" value="<?php echo $isi['jumlah'];?>" class="form-control" id="jumlah_input">
    ...
    <td>
        <button type="submit" class="btn btn-warning" onclick="return validateJumlah()">Update</button>
    </form>
    <!-- aksi ke table penjualan -->
    <a href="fungsi/hapus/hapus.php?jual=jual&id=<?php echo $isi['id_penjualan'];?>&brg=<?php echo $isi['id_barang'];?>&jml=<?php echo $isi['jumlah']; ?>"  class="btn btn-danger"><i class="fa fa-times"></i>
    </a>
</td>
<script>
function validateJumlah() {
    var jumlahInput = document.getElementById("jumlah_input").value;
    if (jumlahInput < 1) {
							...
							<tr>
								...
								<td>
									...
									<button class="btn btn-secondary">
										<i class="fa fa-print"></i> Bukti Pembayaran
									</button></a>
								</td>
							</tr>
						</table>
