...
<div class="row">
    ...
    <div class="col-sm-5">
        <div class="card card-primary">
            <div class="card-header">
                <h5 class="mt-2"><i class="fa fa-user"></i> data admin </h5>
            </div>
            <div class="card-body">
    ...
    <div class="input-group">
        <input type="text" class="form-control" style="border-radius:0px;" name="nama"
            ...
            required="required" pattern="[a-zA-Z ]+" title="Nama hanya boleh berisi huruf dan spasi" minlength="3" />
    </div>
</div>
                            <div class="control-group mb-3">
    ...
    <div class="input-group">
        <input type="text" class="form-control" style="border-radius:0px;" name="tlp" pattern="[0-9]{9,13}" title="Telepon harus berisi angka dan memiliki panjang 9 hingga 13 karakter" value="<?php echo $hasil['telepon']; ?>" required="required" />
    </div>
</div>
<div class="control-group mb-3">
    <label class="control-label" for="typeahead">NIK </label>
    <div class="input-group">
        <input type="text" class="form-control" style="border-radius:0px;" name="nik" pattern="[0-9]{16}" title="NIK harus berisi angka dan memiliki panjang 16 karakter" value="<?php echo $hasil['NIK']; ?>" maxlength="16" required="required" />
    </div>
</div>
                            <div class="control-group mb-3">
    ...
    <div class="input-group">
        <input type="text" class="form-control" style="border-radius:0px;" name="user" data-items="4" value="<?php echo $hasil['user'];?>" minlength="6" title="Username harus memiliki setidaknya 6 karakter" />
    </div>
</div>
<div class="control-group mb-3">
    <label class="control-label" for="typeahead">Password Baru</label>
    <div class="input-group">
        <input type="password" class="form-control" placeholder="Enter Your New Password" id="pass" name="pass" data-items="4" value="" minlength="6" required="required" title="Password harus memiliki setidaknya 6 karakter" />
    </div>
</div>
