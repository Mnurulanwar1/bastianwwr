...
?>
<a href="index.php?page=barang" class="btn btn-success mb-3"><i class="fa fa-angle-left"></i> Balik </a>
<h4>Edit Barang</h4>
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            <form action="fungsi/edit/edit.php?barang=edit" method="POST">
                ...
                <tr>
                    <td>Harga Beli</td>
                    <td><input type="number" class="form-control" value="<?php echo $hasil['harga_beli'];?>" name="beli" min="0"></td>
                </tr>
                <tr>
                    <td>Harga Jual</td>
                    <td><input type="number" class="form-control" value="<?php echo $hasil['harga_jual'];?>" name="jual" min="0"></td>
                </tr>
                <tr>
                    <td>Satuan Barang</td>
                    <td>
                ...
                <tr>
                    <td>Stok</td>
                    <td><input type="number" class="form-control" value="<?php echo $hasil['stok'];?>" name="stok" min="0"></td>
                </tr>
                <tr>
