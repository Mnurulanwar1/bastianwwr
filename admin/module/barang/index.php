...
<?php 
    ...
    if($r > 0){
        ...
        <div class='alert alert-warning'>
            <span class='glyphicon glyphicon-info-sign'></span> Ada <span style='color:blue'>$r</span> barang yang stok tersisa kurang dari <span style='color:red'>2</span> item. Silahkan pesan lagi !!
            <span class='pull-right'><a href='index.php?page=barang&stok=yes'>Periksa Barang <i class='fa fa-angle-one-right'></i></a></span>
        </div>
        ";    
    }
?>
...
<tr>
    ...
    <td>
        ...
        <form method="POST" action="fungsi/edit/edit.php?stok=edit">
            <input type="number" name="restok" class="form-control" min="1" required> <!-- Menambah atribut min="1" dan required -->
            ...
            <a href="fungsi/hapus/hapus.php?barang=hapus&id=<?php echo $isi['id_barang'];?>"
                onclick="javascript:return confirm('Hapus barang ini?');" class="btn btn-danger btn-sm">Hapus</a>
            <?php if(isset($_GET['error']) && $_GET['error'] == 'zero'){ ?> <!-- Menampilkan pesan kesalahan -->
                <p style="color: red;">Stok yang dimasukkan harus lebih dari 0.</p>
            <?php } ?>
        </form>
        <?php }?>
        <?php if($isi['stok'] >= 3){?>
            ...
            <form action="fungsi/tambah/tambah.php?barang=tambah" method="POST">
                <div class="modal-body">
                    <table class="table table-striped bordered">
                        ...
                        <tr>
                            <td>Harga Beli</td>
                            <td><input type="number" placeholder="Harga beli" min="0" required class="form-control"
                                    name="beli"></td>
                        </tr>
                        <tr>
                            <td>Harga Jual</td>
                            <td><input type="number" placeholder="Harga Jual" min="0" required class="form-control"
                                    name="jual"></td>
                        </tr>
                        <tr>
                            <td>Satuan Barang</td>
                        ...
                        <tr>
                            <td>Stok</td>
                            <td><input type="number" min="0" required Placeholder="Stok" class="form-control"
                                    name="stok"></td>
                        </tr>
                        <tr>
                            <td>Tanggal Input</td>
